...
static function X2AbilityTemplate ArcThrowerAbility()
{
	...
	Template.BuildInterruptGameStateFn = class'X2Ability_ItemGrantedAbilitySet'.static.SKULLJACK_BuildInterruptGameState;
	Template.BuildVisualizationFn = ArcThrower_BuildVisualization;
...
simulated function ArcThrower_BuildVisualization(XComGameState VisualizeGameState)
{
	...
	SynceMeleeAction.SourceAnim = 'FF_SkulljackerMissA'; // NOTE: Change this if you need a different attack animation
	SynceMeleeAction.TargetAnim = 'FF_SkulljackedMissA'; // NOTE: Change this if you need a different defender animation
