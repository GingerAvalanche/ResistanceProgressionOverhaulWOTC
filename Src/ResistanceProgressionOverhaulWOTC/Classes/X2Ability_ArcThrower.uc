...
static function X2AbilityTemplate ArcThrowerAbility() // TODO: Change everything from old Psijack setup to new Arc Thrower setup
{
	...
	Template.BuildVisualizationFn = class'X2Ability_ItemGrantedAbilitySet'.static.SKULLJACK_BuildVisualization;
